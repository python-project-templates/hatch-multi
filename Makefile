...
lint-py:  ## lint python with ruff
	python -m ruff check hatch_multi
	python -m ruff format --check hatch_multi
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix hatch_multi
	python -m ruff format hatch_multi
...
test:  ## run python tests
	python -m pytest -v hatch_multi/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v hatch_multi/tests --cov=hatch_multi --cov-report term-missing --cov-report xml
